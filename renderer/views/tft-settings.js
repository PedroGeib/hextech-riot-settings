...
const view = createGameSettingsView({
  ...
  subtitle: 'TFT options and the general settings it shares with League',
  ...
  categories: ['TFT Options', 'HUD & Chat', 'Engine', 'Audio', 'Controls', 'Other Settings'],
  categorize: (info) => {
